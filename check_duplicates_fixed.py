...
def main():
    ...
    parser.add_argument("-t", "--table", default="axe_assistant_prompts_and_responses", help="Table to check for duplicates (default: axe_assistant_prompts_responses)")
